...
# TCS34725
# This code is designed to work with the TCS34725_I2CS I2C Mini Module available from <span class="skimlinks-unlinked">ControlEverything.com</span>.
# <span class="skimlinks-unlinked">https://www.controleverything.com/products</span>
# NT
...
# Get I2C bus
bus = <span class="skimlinks-unlinked">smbus.SMBus(1</span>)
...
print " ***************************************************** "
<span class="skimlinks-unlinked">time.sleep(1</span>)